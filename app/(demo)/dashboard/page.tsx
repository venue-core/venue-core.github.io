        ...
        {STATISTICS1.map((s) => (
          ...
          >
            <div className="inline-flex justify-center items-center">
              <span
                className={`w-2 h-2 inline-block bg-${s.color}-500 rounded-full mr-2`}
              />
              ...
              <div className="p-4 md:p-5 flex gap-x-4">
                ...
                <div className="grow">
                  ...
                  <div className="mt-1 flex items-center gap-x-2">
                    ...
                    <span
                      className={`inline-flex items-center gap-0.5 py-0.5 px-2 rounded-full bg-${color}-100 text-${color}-900`}
                    >
                      <svg
